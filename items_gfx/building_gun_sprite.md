...
This document describes the sprite and animation data for the Building Gun item in Noita.

## Sprite

The main sprite for the Building Gun.

### Key Attributes:

*   **filename**: `data/items_gfx/building_gun.png` - The path to the sprite image file.
*   **offset\_x**: `6` - Horizontal offset for the sprite.
*   **offset\_y**: `3` - Vertical offset for the sprite.

## RectAnimation: default

Defines the animation for the Building Gun's default state.
...
*   **frame\_width**: `15` - The width of each animation frame.
