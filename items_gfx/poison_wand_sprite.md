---
title: Poison Wand Sprite
category: items_gfx
---

# Poison Wand Sprite

This documentation describes the sprite and animation data for the Poison Wand item in Noita.

## Sprite

The primary sprite for the Poison Wand is defined by the `<Sprite>` tag.

### Key Attributes:

*   **filename**: `data/items_gfx/poisonwand.png` - The path to the image file used for the sprite.
...
*   **frame\_width**: `17` - The width of each individual animation frame.
