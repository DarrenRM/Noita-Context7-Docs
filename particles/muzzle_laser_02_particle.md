---
title: Muzzle Laser 02 Particle
category: particles
---

---

# Muzzle Laser 02 Particle

This document describes the `muzzle_laser_02.xml` particle file, used for muzzle flashes in Noita.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_laser_02.png` - The texture file for the particle.
