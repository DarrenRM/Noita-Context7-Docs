---
title: Muzzle Magic Large 03 Particle
category: particles
---

# Muzzle Magic Large 03 Particle

This document describes the configuration for a muzzle flash particle effect in Noita, specifically `muzzle_magic_large_03.xml`.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_magic_large_03.png` - Specifies the image file used for the particle.
...
*   **name**: `muzzle` - Identifies this specific animation.
