---
title: Pink Muzzle Flash 02 Particle
category: particles
---

# Pink Muzzle Flash 02 Particle

This document describes the configuration for a pink muzzle flash particle effect in Noita, designed for AI-assisted modding.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_pink_02.png` - Specifies the texture file for the particle.
