---
title: Large Pink Muzzle Flash 03
category: particles
---

# Large Pink Muzzle Flash 03

This documentation describes the `muzzle_large_pink_03.xml` particle effect, commonly used for muzzle flashes in Noita.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_large_pink_03.png` - Specifies the texture file for the sprite.
