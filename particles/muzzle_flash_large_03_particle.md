---
title: Muzzle Flash Large 03 Particle
category: particles
---

# Muzzle Flash Large 03 Particle
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_large_03.png` - Specifies the texture file used for the particle.
...
This specific configuration defines a single-frame animation, creating a static visual effect for the muzzle flash.