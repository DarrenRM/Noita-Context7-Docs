---
title: Pink Muzzle Flash 04 Particle
category: particles
---

# Pink Muzzle Flash 04 Particle

This document describes the `muzzle_pink_04.xml` particle file, used for a specific muzzle flash effect in Noita.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_pink_04.png` - Specifies the texture file for the sprite.
