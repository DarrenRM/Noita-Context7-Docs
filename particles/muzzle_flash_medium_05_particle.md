---
title: Muzzle Flash Medium 05 Particle
category: particles
---

---

# Muzzle Flash Medium 05 Particle

This document describes the configuration for a muzzle flash particle effect in Noita, specifically `muzzle_medium_05.xml`.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_medium_05.png`
