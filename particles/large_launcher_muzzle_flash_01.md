---
title: Large Launcher Muzzle Flash 01
category: particles
---

# Large Launcher Muzzle Flash 01

This documentation describes the particle effect for a large launcher's muzzle flash, specifically `muzzle_launcher_large_01.xml`.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_launcher_large_01.png` - The texture file used for the sprite.
...
This animation consists of a single frame, creating a static visual effect for the muzzle flash.