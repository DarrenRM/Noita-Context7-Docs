---
title: Blue Magic Launcher Muzzle Flash 05
category: particles
---

# Blue Magic Launcher Muzzle Flash 05

This particle effect represents a blue muzzle flash for a magic launcher, specifically the fifth variation. It's designed to be a brief visual cue upon firing.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_magic_launcher_blue_05.png` - The texture file used for the sprite.
