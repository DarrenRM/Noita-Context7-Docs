---
title: Large Launcher Muzzle Flash 02
category: particles
---

# Large Launcher Muzzle Flash 02

This documentation describes the particle effect for a large launcher's muzzle flash, specifically `muzzle_launcher_large_02.xml`.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_launcher_large_02.png` - The texture file used for the sprite.
