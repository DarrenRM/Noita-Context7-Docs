---
title: Muzzle Launcher 01 Particle
category: particles
---

# Muzzle Launcher 01 Particle

This document describes the `muzzle_launcher_01.xml` particle file, used for muzzle flashes in Noita.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_launcher_01.png` - The texture file for the muzzle flash.
