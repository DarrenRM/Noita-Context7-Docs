---
title: Large Muzzle Flash 01 Particle
category: particles
---

# Large Muzzle Flash 01 Particle

This document describes the configuration for a large muzzle flash particle effect in Noita, specifically `muzzle_large_01.xml`.
...
*   **filename**: `data/particles/muzzle_flashes/muzzle_large_01.png` - Specifies the image file used for the particle.
