...
This document describes the sprite and animation data for `root_1.xml`, a component of the root verlet chain in Noita.
...
*   **filename**: `data/entities/verlet_chains/root/root_parts/root.png` - The texture file used for the sprite.
