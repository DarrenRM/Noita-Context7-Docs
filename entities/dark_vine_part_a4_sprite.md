---
title: Dark Vine Part A4 Sprite
category: entities
---

# Dark Vine Part A4 Sprite
...
*   **filename**: `data/entities/verlet_chains/vines/vine_parts/vine_dark_a.png` - Specifies the texture file used for the sprite.
...
*   **pos\_x**: `12` - The starting X coordinate within the sprite sheet for this animation frame.
*   **pos\_y**: `0` - The starting Y coordinate within the sprite sheet for this animation frame.
