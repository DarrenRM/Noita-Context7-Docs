---
title: Tentacle Projectile 4 Sprite
category: entities
---

# Tentacle Projectile 4 Sprite

This document describes the sprite component for the "tentacle_4" projectile entity in Noita.
...
*   **`image_file`**: Specifies the texture file used for the sprite.
    *   Value: `"data/entities/projectiles/tentacle/tentacle_4.png"`
