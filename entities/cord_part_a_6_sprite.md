---
title: Cord Part A (6) Sprite
category: entities
---

# Cord Part A (6) Sprite

This document describes the sprite data for a specific part of a cord entity in Noita.
...
This section details the `stand` animation for the cord part sprite.

### Key Attributes:

*   **name**: `stand` - The name of this animation.
*   **pos\_x**: `24` - The X-coordinate within the sprite sheet for the animation's starting frame.
