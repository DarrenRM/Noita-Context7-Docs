---
title: Tentacle Verlet 3 Sprite
category: entities
---

# Tentacle Verlet 3 Sprite

This document describes the sprite component for the "Tentacle Verlet 3" entity in Noita.
...
*   **`image_file`**: Specifies the path to the sprite's image file.
    *   Value: `"data/entities/animals/boss_pit/tentacle_3.xml"`
